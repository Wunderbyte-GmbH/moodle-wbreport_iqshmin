...
/**
 * Entry point for the IQSHMIN statistics report.
 *
 * @package     wbreport_iqshmin
 * @copyright   2026 Wunderbyte GmbH <info@wunderbyte.at>
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
use wbreport_iqshmin\output\iqshmin;
...
$title = get_string('pluginname', 'wbreport_iqshmin');
$url   = new moodle_url('/local/wb_reports/wbreport/iqshmin/report.php');
